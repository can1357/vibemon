...
//!
//! [`Exit`] is the unified vCPU run result. KVM may hand MMIO/PIO accesses back
//! to the generic run loop, while HVF/WHP self-complete those accesses and use
//! `Continue` for handled-in-place exits.
